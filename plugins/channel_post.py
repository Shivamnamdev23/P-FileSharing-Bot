...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start','users','broadcast','batch','genlink','stats','set_fsub','check_fsub','on_fsub','off_fsub','add_admin','del_admin','admins']))
